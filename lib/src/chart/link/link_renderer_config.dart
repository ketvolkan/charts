...
class LinkRendererConfig<D> extends LayoutViewConfig implements SeriesRendererConfig<D> {
  @override
  ...
  LinkRendererConfig({this.customRendererId, this.layoutPaintOrder = LayoutViewPaintOrder.bar, SymbolRenderer? symbolRenderer})
