...
class NumericAxisSpec extends AxisSpec<num> {
  ...
  factory NumericAxisSpec.from(
    ...
    return NumericAxisSpec(
      ...
      tickFormatterSpec: (tickFormatterSpec ?? other.tickFormatterSpec) as NumericTickFormatterSpec?,
...
class BasicNumericTickProviderSpec implements NumericTickProviderSpec {
  ...
  const BasicNumericTickProviderSpec(
      {this.zeroBound, this.dataIsInWholeNumbers, this.desiredTickCount, this.desiredMinTickCount, this.desiredMaxTickCount});
