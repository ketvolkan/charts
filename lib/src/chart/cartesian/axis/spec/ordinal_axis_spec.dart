...
import 'package:charts_flutter/src/chart/cartesian/axis/scale.dart' show RangeBandConfig;
...
class OrdinalAxisSpec extends AxisSpec<String> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other is OrdinalAxisSpec && viewport == other.viewport && super == other);
  }
...
class StaticOrdinalTickProviderSpec implements OrdinalTickProviderSpec {
  ...
  @override
  StaticTickProvider<String> createTickProvider(ChartContext context) => StaticTickProvider<String>(tickSpecs);

  @override
  bool operator ==(Object other) => identical(this, other) || (other is StaticOrdinalTickProviderSpec && tickSpecs == other.tickSpecs);
...
class AutoAdjustingStaticOrdinalTickProviderSpec implements OrdinalTickProviderSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || (other is AutoAdjustingStaticOrdinalTickProviderSpec && tickSpecs == other.tickSpecs);
...
class RangeOrdinalTickProviderSpec implements OrdinalTickProviderSpec {
  ...
  @override
  RangeTickProvider<String> createTickProvider(ChartContext context) => RangeTickProvider<String>(tickSpecs);

  @override
  bool operator ==(Object other) => identical(this, other) || (other is RangeOrdinalTickProviderSpec && tickSpecs == other.tickSpecs);
...
class BasicOrdinalTickFormatterSpec implements OrdinalTickFormatterSpec {
  ...
  @override
  OrdinalTickFormatter createTickFormatter(ChartContext context) => OrdinalTickFormatter();
...
class FixedPixelSpaceOrdinalScaleSpec implements OrdinalScaleSpec {
  ...
  @override
  OrdinalScale createScale() => SimpleOrdinalScale()..rangeBandConfig = RangeBandConfig.fixedPixelSpaceBetweenStep(pixelSpaceBetweenBars);
...
class FixedPixelOrdinalScaleSpec implements OrdinalScaleSpec {
  ...
  @override
  OrdinalScale createScale() => SimpleOrdinalScale()..rangeBandConfig = RangeBandConfig.fixedPixel(pixels);
