...
class TreeMapRendererConfig<D> extends LayoutViewConfig implements SeriesRendererConfig<D> {
  /// Default padding of a treemap rectangle.
  static const _defaultRectPadding = ViewMargin(topPx: 26, leftPx: 4, rightPx: 4, bottomPx: 4);
  ...
  BaseTreeMapRenderer<D> build() {
    switch (tileType) {
      case TreeMapTileType.dice:
        return DiceTreeMapRenderer<D>(config: this, rendererId: customRendererId);
      case TreeMapTileType.slice:
        return SliceTreeMapRenderer<D>(config: this, rendererId: customRendererId);
      case TreeMapTileType.sliceDice:
        return SliceDiceTreeMapRenderer<D>(config: this, rendererId: customRendererId);
      default:
        return SquarifiedTreeMapRenderer<D>(config: this, rendererId: customRendererId);
    }
  }
}
