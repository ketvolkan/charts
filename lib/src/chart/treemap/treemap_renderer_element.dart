...
class TreeMapRendererElement<D> {
  ...
  TreeMapRendererElement<D> clone() => TreeMapRendererElement(
        boundingRect: _boundingRect == null ? null : Rectangle.fromPoints(boundingRect.topLeft, boundingRect.bottomRight),
        area: area,
        fillPattern: fillPattern,
        fillColor: fillColor == null ? null : Color.fromOther(color: fillColor!),
        patternColor: patternColor == null ? null : Color.fromOther(color: patternColor!),
        strokeColor: strokeColor == null ? null : Color.fromOther(color: strokeColor!),
  ...
  void refreshPaintProperties() {
    ...
    fillPattern = series.fillPatternFn == null ? FillPatternType.solid : series.fillPatternFn!(index);
  ...
  void updateAnimationPercent(TreeMapRendererElement<D> previous, TreeMapRendererElement<D> target, double animationPercent) {
