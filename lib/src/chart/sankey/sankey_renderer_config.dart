...
class SankeyRendererConfig<D> extends LayoutViewConfig implements SeriesRendererConfig<D> {
  @override
  ...
  SankeyRendererConfig({this.customRendererId, this.layoutPaintOrder = LayoutViewPaintOrder.sankey, SymbolRenderer? symbolRenderer})
