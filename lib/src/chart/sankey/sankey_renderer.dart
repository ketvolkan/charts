...
class SankeyRenderer<D> extends BaseSeriesRenderer<D> {
  ...
  factory SankeyRenderer({String? rendererId, SankeyRendererConfig<D>? config}) {
    return SankeyRenderer._internal(rendererId: rendererId ?? defaultRendererID, config: config ?? SankeyRendererConfig());
  }
